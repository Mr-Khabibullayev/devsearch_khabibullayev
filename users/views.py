...
def loginUser(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            messages.error(request,'Username does not axist')
...
def createSkill(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            skill.owner = profile
            skill.save()
            messages.success(request,'Skills was added successfuly!')
            return redirect('account')
...
def updateSkill(request,pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request,'Skills was updated successfuly!')
            return redirect('account')
...
def deleteSkills(request,pk):
    ...
    if request.method == 'POST':
        skill.delete()
        messages.success(request,'Skills was deleted successfuly!')
        return redirect('account')
